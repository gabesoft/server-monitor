...
bar percentage =
    ...
    in
        svg
            ...
            [ rect [ class "background", x "0", y "0", width w, height h ] []
            , rect [ class "foreground", x "0", y "0", width (Basics.toString (200 * percentage / 100)), height h ] []
            , text'
                [ x "50%"
                , y "50%"
                ...
                [ text (Basics.toString percentage ++ "%") ]
            ]
