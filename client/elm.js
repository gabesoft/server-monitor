...
var _gabesoft$server_monitor$DateFormat$padWith = function (c) {
	return function (_p0) {
		return A3(
...
var _gabesoft$server_monitor$DateFormat$zero2twelve = function (n) {
	return _elm_lang$core$Native_Utils.eq(n, 0) ? 12 : n;
};
var _gabesoft$server_monitor$DateFormat$mod12 = function (h) {
	return A2(_elm_lang$core$Basics_ops['%'], h, 12);
};
var _gabesoft$server_monitor$DateFormat$fullDayOfWeek = function (dow) {
	var _p1 = dow;
	switch (_p1.ctor) {
		case 'Mon':
			return 'Monday';
...
var _gabesoft$server_monitor$DateFormat$monthToFullName = function (m) {
	var _p2 = m;
	switch (_p2.ctor) {
		case 'Jan':
			return 'January';
...
var _gabesoft$server_monitor$DateFormat$monthToInt = function (m) {
	var _p3 = m;
	switch (_p3.ctor) {
		case 'Jan':
			return 1;
...
var _gabesoft$server_monitor$DateFormat$formatToken = F2(
	function (d, m) {
		var symbol = function () {
		...
		switch (_p5) {
			...
			case 'm':
				return A3(
					...
					_elm_lang$core$Basics$toString(
						_gabesoft$server_monitor$DateFormat$monthToInt(
							_elm_lang$core$Date$month(d))));
			case 'B':
				return _gabesoft$server_monitor$DateFormat$monthToFullName(
					_elm_lang$core$Date$month(d));
			case 'b':
				return _elm_lang$core$Basics$toString(
					_elm_lang$core$Date$month(d));
			case 'd':
				return A2(
					_gabesoft$server_monitor$DateFormat$padWith,
					_elm_lang$core$Native_Utils.chr('0'),
			...
			case 'A':
				return _gabesoft$server_monitor$DateFormat$fullDayOfWeek(
					_elm_lang$core$Date$dayOfWeek(d));
			case 'H':
				return A2(
					_gabesoft$server_monitor$DateFormat$padWith,
			...
			case 'I':
				return A2(
					_gabesoft$server_monitor$DateFormat$padWith,
					_elm_lang$core$Native_Utils.chr('0'),
					_gabesoft$server_monitor$DateFormat$zero2twelve(
						_gabesoft$server_monitor$DateFormat$mod12(
							_elm_lang$core$Date$hour(d))));
			case 'l':
				return A2(
					_gabesoft$server_monitor$DateFormat$padWith,
...
var _gabesoft$server_monitor$DateFormat$re = _elm_lang$core$Regex$regex('%(%|Y|m|B|b|d|e|a|A|H|k|I|l|p|P|M|S)');
var _gabesoft$server_monitor$DateFormat$format = F2(
	function (s, d) {
		return A4(
			_elm_lang$core$Regex$replace,
			_elm_lang$core$Regex$All,
			_gabesoft$server_monitor$DateFormat$re,
			_gabesoft$server_monitor$DateFormat$formatToken(d),
			s);
	});
var _gabesoft$server_monitor$DateFormat$formatISO8601 = _gabesoft$server_monitor$DateFormat$format('%Y-%m-%dT%H:%M:%SZ');

var _gabesoft$server_monitor$Types$Process = F8(
	function (a, b, c, d, e, f, g, h) {
		return {name: a, host: b, status: c, pid: d, started: e, current: f, memory: g, cpu: h};
	});
var _gabesoft$server_monitor$Types$Down = function (a) {
	return {ctor: 'Down', _0: a};
};
var _gabesoft$server_monitor$Types$Running = {ctor: 'Running'};
...
var _gabesoft$server_monitor$Main$readFirstStatus = function (url) {
	var obj = _elm_lang$core$Json_Encode$object(
		_elm_lang$core$Native_List.fromArray(
			[
				...
				ctor: '_Tuple2',
				_0: 'type',
				_1: _elm_lang$core$Json_Encode$string('readStatus')
			}
			]));
	var msg = A2(_elm_lang$core$Json_Encode$encode, 0, obj);
...
var _gabesoft$server_monitor$Main$init = function (flags) {
	...
	return {
		...
		_1: _gabesoft$server_monitor$Main$readFirstStatus(url)
	};
};
...
var _gabesoft$server_monitor$Main$subscriptions = function (model) {
	return A2(_elm_lang$websocket$WebSocket$listen, model.url, _gabesoft$server_monitor$Main$NewMessage);
};
...
var Elm = {};
Elm['Main'] = Elm['Main'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Main'], 'Main', typeof _gabesoft$server_monitor$Main$main === 'undefined' ? null : _gabesoft$server_monitor$Main$main);
